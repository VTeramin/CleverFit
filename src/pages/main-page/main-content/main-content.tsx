...
export const MainContent: React.FC = () => {
    ...
    const navBlocks = [HeartTwoTone, CalendarTwoTone, IdcardTwoTone].map((icon, index) => (
        <div key={navBlocksSubtitles[index]} className={classNames(styles.nav__block, styles.box)}>
    ...
    return (
        <Content className={styles.content} >
            <section className={classNames(styles['content__list-wrapper'], styles.box)}>
            ...
            <h2 className={classNames(styles.content__tagline, styles.box)}>CleverFit — это не просто приложение, а твой личный помощник в&nbsp;мире фитнеса. Не откладывай на завтра  — начни тренироваться уже сегодня!</h2>
