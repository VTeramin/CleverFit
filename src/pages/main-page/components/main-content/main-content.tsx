...
export const MainContent: React.FC = () => {
    ...
    return (
        <Content className="content" >
            ...
            <h2 className="content__slogan box">CleverFit — это не просто приложение, а твой личный помощник в&nbsp;мире фитнеса. Не откладывай на завтра  — начни тренироваться уже сегодня!</h2>
